...
#Ordered, changable & contains duplicate values

#help(vehicles)
#print(dir(vehicles))  To known about list related functions or set or tuple

print("List of items : "+str(vehicles))

l = len(vehicles)
print("Length of the list : "+str(l))

vehicles.append("bus")
print("\nAppended : "+str(vehicles))
